...
//        if (holder instanceof viewholder3) {
            holder.author1.setText(list.get(position).get("author").toString());
            holder.content1.setText(list.get(position).get("content").toString());
            holder.time1.setText(list.get(position).get("time").toString());
            Glide.with(context).load(list.get(position).get("picture")).into(holder.avater1);
//        }
